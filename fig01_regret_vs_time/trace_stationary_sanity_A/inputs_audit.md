...
Date: 2026-01-27 23:02:10.513166
Context: input_dir=fig01_regret_vs_time/inputs_stationary_sanity_A, out_dir=fig01_regret_vs_time/trace_stationary_sanity_A, regret_mode=pseudo_regret, T=10000
## File Filtering
...
| sw_ucb | 13726.86 | N/A | 0.0000 | 0.00% |
| lagrangian_ppo | 18325.38 | N/A | 0.0000 | 0.00% |
...
|---|---|---|---|
| raucb_plus | 186.21 | 0.0140 | OK |
| safeopt_gp | 961.93 | 0.9225 | High Slope? |
| safe_linucb | 97.72 | 0.0900 | OK |
| sw_ucb | 1490.38 | 1.0474 | Exploding? |
| lagrangian_ppo | 1989.65 | 1.8257 | Exploding? |
...
[5.1] RA-UCB++ Slope Analysis:
  Interval [1, 2000]: Slope = 0.6026
  Interval [2001, 6000]: Slope = 0.1112
  Interval [6001, 10000]: Slope = 0.0155

[5.2] RA-UCB++ Early Jump Analysis (t < 2000):
  Max Slope Window (width 200): [201, 401]
  Max Slope Value: 1.8280
...
[Comparison] Final Stage Slope (6001-10000):
  ...
  safe_linucb: 0.0900
  sw_ucb: 1.0887
  lagrangian_ppo: 1.8251

## Final Regret Ranking
| Rank | Algo | Final Mean Regret |
|---|---|---|
| 1 | safe_linucb | 900.00 |
| 2 | raucb_plus | 1715.05 |
| 3 | safeopt_gp | 8859.69 |
| 4 | sw_ucb | 13726.86 |
| 5 | lagrangian_ppo | 18325.38 |

[WARN] RA-UCB++ is NOT the best performing algorithm in terms of Final Regret.
